...
var decodeAudioDataFast = require('@soundcut/decode-audio-data-fast');
...
function getFileAudioBuffer(file, audioCtx, opts) {
  return decodeAudioDataFast.getFileAudioBuffer(file, audioCtx, opts).catch((err) => {
...
class AudioWaveformPlayer extends HTMLElement {
  constructor() {
    ...
    this.renderer = uhtml.render.bind(this, this.shadowRoot);
  ...
  render() {
    ...
    return this.renderer(uhtml.html`
      <style>
        ${`
        * {
...
//# sourceMappingURL=audio-waveform-player-element.cjs.js.map
